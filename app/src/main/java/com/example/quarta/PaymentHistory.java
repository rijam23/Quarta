...
public class PaymentHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = "https://script.google.com/macros/s/AKfycbzL0Znz4V145qSv690hyp93uswxg3mk1XVM6QIYRJZ7iLi1iX2OJ12c0Iw42FGL3L4a/exec";
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        for (int i = 0; i < cast.length(); i++) {
                            ...
                            String lastPayment = actor.getString("date");
